...
export function AboutPage(): React.JSX.Element {
  const technologies = ['Python', 'React', 'TypeScript', 'Vite', 'Three.js', 'Online-3D-Viewer', 'FastAPI', 'Vercel'];
          ...
          <div className="container mx-auto px-4 py-8">
            <Card className="mb-8">
              <CardHeader className="text-center">
                <CardTitle className="text-4xl">ℹ️ Sobre o Projeto</CardTitle>
              </CardHeader>
            </Card>
            ...
            <Card>
              <CardContent className="space-y-8">
                ...
                <section>
                  <CardHeader className="px-0 pb-4">
                    <CardTitle className="text-2xl">🛠️ Tecnologias</CardTitle>
                  </CardHeader>
